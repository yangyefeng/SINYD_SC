...
public:
    ...
    @return    void：无
    */
    void _DeleteFile(char *filename);
	...
	*/
	bool _CreateFile(char *filename, char *wstr = NULL);
    ...
    @return    void：无
    */
    void _ClearFileContent(char *filename);
    ...
    @return     void：无
    */
    void _InsertLog(char *logString,char *filePath);
    ...
    @return     bool：写入是否成功
    */
    bool _WriteProfileString(char lpAppName[], char lpKeyName[], char lpString[], char lpFileName[]);
    ...
    */
	int _GetProfileString(const char lpAppName[], const char lpKeyName[], const char lpDefault[], char lpReturnedString[], const char lpFileName[]);
    ...
    */
	int _GetProfileInt(const char lpAppName[], const char lpKeyName[], int nDefault, const char lpFileName[]);

	bool _WriteProfileInt(char lpAppName[], char lpKeyName[], int value, char lpFileName[]);
    ...
    @return    void：无
    */
    void _WriteDebugForLog(char logstr[], char FileName[]);
