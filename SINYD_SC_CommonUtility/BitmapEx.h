...
#ifdef _WIN32
#   ifdef BITMAPEX_EXPORT
#       define BITMAPEX_LIB __declspec(dllexport)
#   elif defined(BITMAPEX_IMPORT)
#       define BITMAPEX_LIB __declspec(dllimport)
#   else
#       define BITMAPEX_LIB
#   endif
#else
...
public:
	...
	void BlackAndWhite2(long offset = 128);
	void Binary_RBG(DWORD rgb, int iThreshold);
	void Binary_OTSU(int &iThreshold);
	void Gray_RGB(DWORD rgb);
	void EdgeDetect();
	...
	void Draw2(long dstX, long dstY, long dstWidth, long dstHeight, CBitmapEx& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight);
	...
	void Get24BPPData(LPBYTE lpData, DWORD* pdwSize);
	...
	void GetPixels(long x, long y, long width, long height, DWORD* pdwPixelBuf, long* inoutBufLength, long* outWidth, long* outHeight);
...
private:
	...
	void _DrawNearestNeighbour2(long dstX, long dstY, long dstWidth, long dstHeight, CBitmapEx& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight);
