...
class Thread
{
  ...
  private:
    ...
    static void *ThreadMainHandler( /*Instance *Param*/void *Param )
    {
...
class Thread<void>
{
  ...
  public:
    ...
    ) const
    {
      ...
      int R;
      if( H ){
          R= pthread_create((pthread_t *)H,&attr,ThreadMainHandler,(void *)&I);
      }else{
          Handle tid;
          R= pthread_create(&tid,&attr,ThreadMainHandler,(void *)&I);
      }
      pthread_attr_destroy(&attr);
