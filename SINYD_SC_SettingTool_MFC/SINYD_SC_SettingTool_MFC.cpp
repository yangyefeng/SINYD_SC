...
// SINYD_SC_SettingTool_MFC.cpp : 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(SCSettingToolApp, CWinApp)
...
SCSettingToolApp::SCSettingToolApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 SCSettingToolApp 对象

SCSettingToolApp theApp;
...
// SCSettingToolApp 初始化

BOOL SCSettingToolApp::InitInstance()
{
